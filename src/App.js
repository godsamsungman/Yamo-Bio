    ...
    <div className="App">
      <header className="App-header">
        <div className="container idCard">
          ...
          <h1 className="nameHeader">Peter Lee</h1>
        </div>

        <h2>
          My name is Peter.
          <br />I am a professional working in
          <br /> Supply Chain Consulting field who is interested in
          <br /> making career transition into
